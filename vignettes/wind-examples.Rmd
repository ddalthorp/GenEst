...
Month (a temporal split that spans the monitoring period):
...
The `AIC` function lists the fitted models in order of
${\small \Delta}$AICc.
...
(`aicc(cpSet_sml)`) that the top 10 models according to AICc are:
