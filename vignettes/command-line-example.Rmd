...
`ghat` is estimated according to a particular search schedule (`SS`), which
here we define as the Unit 1 search schedule:
...
SS <- SS[ which(SS$Unit1 == 1), "DateSearched"]

ghatsGeneric <- rghatGeneric(n = 1000, SS, model_SE, model_CP, seed_SE = 1,
