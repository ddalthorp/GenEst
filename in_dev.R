...
#' @param seed_Mhat seed for the random draws of the Mhats
...
estM <- function(nsim = 1, data_CO, data_SS, data_DWP, frac = 1,  
  ...
  DWP <- DWPbyCarcass(data_DWP, data_CO, data_SS, dateFoundCol, 
           dateSearchedCol, DWPCol, unitCol
         )
  ghatAj <- estghat(nsim, data_CO, data_SS, model_SE, model_CP, seed_SE,  
