...
```{r, fig.show = "hold", fig.width = 6, fig.height = 6, fig.align = 'center', include = F}
plot(gsGeneric)
```
...
```{r, fig.show = "hold", fig.width = 4, fig.height = 4, fig.aling = 'center'}
...
```{r, fig.show = "hold", fig.width = 4, fig.height = 4, fig.align = 'center'}
