---
title: "Tutorial with Wind Examples"
author: "Dan Dalthorp"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Tutorial with Wind Examples}
...
plot(pkSet_sml, specificModel = "p ~ Visibility; k ~ Visibility + Season")
```
...
(`p ~ Visibility; k ~ 1`, with $latex\Delta$AICc = 1.596) is able to succesfully
...
By comparison, the model with the highest $latex\DeltaAICc$ (= 41.5) has \
...
```{r, fig.show = "hold", fig.width = 7, fig.height = 7}
plot(pkSet_sml, eval = F, specificModel = "p ~ Season; k ~ Season")
```
